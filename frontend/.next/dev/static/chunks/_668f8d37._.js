...
function ChatPageContent() {
    ...
    const [providerModelMap, setProviderModelMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({}) // provider -> modelId
    ;
    const [enabledProviders, setEnabledProviders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]) // List of enabled providers
    ;
    // Auto-scroll refs
                ...
                "ChatPageContent.useEffect.fetchInitialData": async ()=>{
                    ...
                    try {
                        ...
                        if (!conversationIdFromUrl && enabledProviders.length === 0 && modelsData.length > 0) {
                            ...
                            const grouped = {};
                            modelsData.filter({
                                "ChatPageContent.useEffect.fetchInitialData": (m)=>subData?.tier_id === "free" ? m.tier === "free" : true
                            }["ChatPageContent.useEffect.fetchInitialData"]).forEach({
                                "ChatPageContent.useEffect.fetchInitialData": (model)=>{
                            ...
                            ;
                            const initialProviderModelMap = {};
                            initialProviders.forEach({
                                "ChatPageContent.useEffect.fetchInitialData": (provider)=>{
                            ...
                            setSelectedModels(initialProviders.map({
                                "ChatPageContent.useEffect.fetchInitialData": (p)=>initialProviderModelMap[p]
                            }["ChatPageContent.useEffect.fetchInitialData"]).filter(Boolean));
                        }
...
_s(ChatPageContent, "Ux5/jVK49PMXxzrb3r0vimqzLoc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_668f8d37._.js.map