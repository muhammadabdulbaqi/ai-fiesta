...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(email, username, password);
            router.push("/");
        } catch (err) {
...
_s(RegisterPage, "yGvhP56B7Y7geElZGzbiNYNH4wo=", false, function() {
    return [
...
//# sourceMappingURL=_7c5f3a0e._.js.map