...
function MultiChatModelSelectors({ selectedModels, onModelsChange, userTier = "free" }) {
                ...
                "MultiChatModelSelectors.useEffect.fetchModels": async ()=>{
                    try {
                        ...
                        const filtered = data.filter({
                            "MultiChatModelSelectors.useEffect.fetchModels.filtered": (m)=>userTier !== "free" || m.tier === "free"
                        }["MultiChatModelSelectors.useEffect.fetchModels.filtered"]);
                        setAvailableModels(filtered);
                        // Initialize with 2-3 models from different providers if empty
                        if (selectedModels.length === 0 && filtered.length > 0) {
                            // Group by provider
                            const byProvider = {};
                            filtered.forEach({
                            ...
                            if (initialModels.length < 2 && filtered.length >= 2) {
                            ...
                            if (initialModels.length === 0 && filtered.length > 0) {
                                initialModels.push(filtered[0].value);
                            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent",
        children: availableModels.map((model)=>{
            const isSelected = selectedModels.includes(model.value);
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-3 bg-card border rounded-lg px-3 py-2 min-w-[200px] flex-shrink-0 transition-all", isSelected ? "border-primary" : "border-border opacity-60"),
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$switch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Switch"], {
                        checked: isSelected,
                        onCheckedChange: (enabled)=>handleToggle(model.value, enabled)
                    }, void 0, false, {
                        fileName: "[project]/components/multi-chat-model-selectors.tsx",
                        lineNumber: 139,
                        columnNumber: 13
...
_s(MultiChatModelSelectors, "34RwM+ypPmVTLcn6C0HDe5PSexc=");
...
//# sourceMappingURL=_9af942d6._.js.map