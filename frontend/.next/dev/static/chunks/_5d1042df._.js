    ...
    const loadConversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useChatSSE.useCallback[loadConversation]": async (conversationId)=>{
            try {
                ...
                // Group assistant messages by conversation_id and timestamp to handle multi-model responses
                ...
                for(let i = 0; i < conversationMessages.length; i++){
                    ...
                    if (msg.role === "user") {
                        ...
                        // Find if there's an assistant message right before this one (same user message context)
                        // Look for the last assistant message that's within 5 seconds (likely same response batch)
                        ...
                        if (lastAssistantIndex !== -1) {
                            const lastAssistant = transformedMessages[lastAssistantIndex];
                            const timeDiff = Math.abs(lastAssistant.timestamp.getTime() - msg.timestamp.getTime());
                            // If within 5 seconds, group as variation (multi-model response)
                            if (timeDiff < 5000 && lastAssistant.variations) {
                                transformedMessages[lastAssistantIndex] = {
                                    ...lastAssistant,
                                    variations: {
                                        ...lastAssistant.variations,
                                        [modelId]: {
                                            modelId,
                                            content: msg.content,
                                            isStreaming: false,
                                ...
                                // New assistant message (different response)
                                transformedMessages.push({
                                    id: msg.id,
                                    role: "assistant",
                                    variations: {
                    ...
                    mode === "multi-chat" && selectedModels.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: selectedModels.map((modelId)=>{
                                // Find model info
                                const modelInfo = subscription?.allowed_models?.find((m)=>m.value === modelId) || {
                                    value: modelId,
                                    label: modelId,
                                    provider: "unknown"
                                };
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ModelResponseColumn, {
                                    modelId: modelId,
...
_s(ChatPage, "8trMUyHJ6n04dSQd0WjBAiB77uA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_5d1042df._.js.map